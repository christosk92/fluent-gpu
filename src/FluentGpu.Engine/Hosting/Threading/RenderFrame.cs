...
/// <b>finished DrawList</b> across the seam: the UI records into a <see cref="DrawListArenaRing"/> arena and publishes
/// this POD header naming that arena; the render thread submits + presents from it. This is the documented Cut-A
...
public struct RenderFrame
{
    ...
    /// <summary>Which <see cref="DrawListArenaRing"/> arena holds this frame's recorded command bytes + sort keys.</summary>
