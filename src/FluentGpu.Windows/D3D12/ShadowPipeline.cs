...
""";
    ...
    public bool Record(ID3D12GraphicsCommandList* cmd, ReadOnlySpan<ShadowInstance> instances, float vpW, float vpH, bool rebind = true)
    {
        int start = _cursor;
        ...
        cmd->SetGraphicsRootShaderResourceView(1, _instances[_active]->GetGPUVirtualAddress() + (ulong)(start * sizeof(ShadowInstance)));
