...
# matching the WaveeMusic style. Run:  powershell -ExecutionPolicy Bypass -File build/generate-download-buttons.ps1
...
if (-not (Test-Path $logoPath)) { throw "missing $logoPath - run build/generate-appicon.ps1 first" }
