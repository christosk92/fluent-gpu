...
# (ops/build/appicon-source.png — the F-monogram). High-quality bicubic downscale per target size.
# Run:  powershell -ExecutionPolicy Bypass -File ops/build/generate-appicon.ps1
