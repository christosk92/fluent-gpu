...
| `app/Wavee/Features/Detail/ArtistGalleryLightbox.cs` | **new** — the lightbox component (chrome, filmstrip, idle, zoom surface, export moved here) |
| `app/Wavee/Features/Detail/ArtistPage.Shelves.cs` | `OpenGallery` rewrite; delete `ArtistGalleryViewer` (lines 209-311) |
